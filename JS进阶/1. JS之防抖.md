...
```
> MouseEvent {isTrusted: true, screenX: 610, screenY: 191, clientX: 610, clientY: 55, …}
```
...
![3](https://user-images.githubusercontent.com/19302489/147653727-224fb8c7-a557-426b-8368-d66ae7c7cc35.gif)

**返回值**
--- 

此时注意一点，就是 getUserAction 函数可能是有返回值的，所以我们也要返回函数的执行结果，但是当 immediate 为 false 的时候，因为使用了 setTimeout ，
我们将 func.apply(context, args) 的返回值赋给变量，最后再 return 的时候，值将会一直是 undefined，所以我们只在 immediate 为 true 的时候返回函数的执行结果。
...
![4](https://user-images.githubusercontent.com/19302489/147654277-fc4a1808-d402-4a55-930a-c7dfeb3d1def.gif)
